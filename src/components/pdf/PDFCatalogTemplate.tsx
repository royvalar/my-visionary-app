...
const PDFCatalogTemplate: React.FC<PDFCatalogTemplateProps> = ({ collection }) => {
    ...
    return (
        <div id="pdf-template" className="pdf-container overflow-hidden" dir="rtl" style={{ position: 'fixed', left: '-9999px', top: '0', backgroundColor: 'white', color: black, width: '210mm' }}>
            {/* Cover Page */}
